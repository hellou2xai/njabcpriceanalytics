...
const STEPS: ScreenStep[] = [
  ...
  { element: '.filter-toolbar-sections', title: 'Narrow the list',
  ...
  { element: '.filter-toolbar-section-title', title: 'Set a minimum drop',
    before: () => scrollIntoView('.filter-toolbar-section-title'),
