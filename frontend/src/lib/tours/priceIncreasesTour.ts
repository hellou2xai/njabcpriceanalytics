...
const STEPS: ScreenStep[] = [
  ...
  { element: '.pm-stack', title: 'Front line vs QD vs RIP',
    before: () => scrollIntoView('.pm-stack'),
    body: 'Each card breaks the price into three rows: the <b>front line case price</b>, the price after the <b>best QD</b>, and the price after the <b>best RIP</b>, each with the per-bottle price and the buy-in. <b>Why it helps:</b> see exactly which lever is holding the price down.' },
