...
const STEPS: ScreenStep[] = [
  ...
  { element: '.filter-toolbar-row', title: 'Narrow the watch-list',
    before: () => scrollIntoView('.filter-toolbar-row'),
  ...
  { element: '.filter-toolbar-sections', title: 'Set a minimum rise',
    before: () => scrollIntoView('.filter-toolbar-sections'),
  ...
  { element: '.filter-toolbar-sections', title: 'Increases that hide behind RIP',
    before: () => scrollIntoView('.filter-toolbar-sections'),
