        ...
        "scenes": [
            ...
            ("Catalog - reading the columns",
             ["Walk left to right across one row's columns.",
              "PRODUCT: image, name, barcode. A blue 'Multiple distributors' tag means the same barcode is carried by several wholesalers; the rarer red 'duplicate' tag means one distributor reused a barcode for different products. A green 'In combo' tag means it is in a bundle (click it to open the bundle in a popup).",
